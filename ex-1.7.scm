...
; fails for small and large numbers. An alternative strategy 
; for implementing good-enough? is to watch how guess changes 
...
(define (square-root-iter x previous-guess guess)
...
(define (square-root x)
  (square-root-iter x 1.0 (improve 1.0 x)))